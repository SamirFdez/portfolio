  ...
  return (
    <section className="d-flex align-items-center hero" id="home">
      <div className="container">
        <div className="row">
          <div className="col-xl-6 pt-5 pt-xl-0 order-2 order-lg-2">
            <h4>Hi, my name is</h4>
            ...
            <h3>
              ...
              into lines of code and creating functional, accessible and useful
              web applications.
            </h3>
            <div>
              <a
          ...
          <div className="col-xl-6 order-1 order-xl-2 hero-img">{View}</div>
        </div>
      </div>
    </section>
  );
